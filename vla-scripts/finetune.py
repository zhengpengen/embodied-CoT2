...
class FinetuneConfig:
    ...
    run_root_dir: Path = Path("/home/michael/embodied-CoT2/")                               # Path to directory to store logs & checkpoints
    ...
    # Tracking Parameters
    wandb_project: str = "zhengpengen"                                  # Name of W&B project to log to (use default!)
    wandb_entity: str = "ECOT2"                          # Name of entity to log under
